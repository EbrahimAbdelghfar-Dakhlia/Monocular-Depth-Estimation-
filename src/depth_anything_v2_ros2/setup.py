...
setup(
    ...
    data_files=[
        ...
        (os.path.join('lib', package_name, submodule_name),
         glob(os.path.join(submodule_name, '*.py'))),
        (os.path.join('lib', package_name, submodule_name, 'dinov2_layers'),
         glob(os.path.join(submodule_name, 'dinov2_layers', '*.py'))),
        (os.path.join('lib', package_name, submodule_name, 'util'),
         glob(os.path.join(submodule_name, 'util', '*.py'))),
